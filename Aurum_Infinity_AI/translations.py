...
TRANSLATIONS: dict = {
    "zh_hk": {
        ...
        "futunn_all":           "全部",
        "futunn_cache_info":    "新聞快取",
        "futunn_cache_desc":    "此頁只讀本地 JSON，不在開頁時即時抓取網站。",
        "futunn_missing":       "目前沒有可顯示的新聞快取內容。",
    ...
    "zh_cn": {
        ...
        "futunn_all":           "全部",
        "futunn_cache_info":    "新闻缓存",
        "futunn_cache_desc":    "此页只读本地 JSON，不会在开页时即时抓取网站。",
        "futunn_missing":       "目前没有可显示的新闻缓存内容。",
    ...
    "en": {
        ...
        "futunn_all":           "All",
        "futunn_cache_info":    "News Cache",
        "futunn_cache_desc":    "This page only reads cached JSON and does not scrape the source site at request time.",
        "futunn_missing":       "No cached news content is currently available.",
